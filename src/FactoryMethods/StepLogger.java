...
public class StepLogger {
	...
	static int i2 = 1;
	 static int count =0;
		...
		public static void logitinfile(double iteration,  String step, String step2, String step3, String stat) throws IOException, InvalidFormatException {
			   ...
			   try {
				   ...
				   Row r; 
				    ...
				    String excelFilePath = "./Reports/Reports.xlsm";
		            ...
		            r = sheet.createRow(0);
		            r.createCell(0).setCellValue("TimeStamp");
		 ...
		 */
		            ...
		            FileOutputStream outputStream = new FileOutputStream("./Reports/Reports.xlsm");
